...
const categories = [
  { id: 1, name: "New Arrivals", path: "/newArrival" },
  { id: 2, name: "Gadgets", path: "/gadgets" },
  { id: 3, name: "Office Accessories", path: "/officeacc" },
  { id: 4, name: "Electronics", path: "/electronics" },
  { id: 5, name: "Others", path: "/others" },
  { id: 6, name: "Perfumes", path: "/perfumes" },
];
          ...
          >
            ...
            {show && (
              <motion.ul
                ...
                className="absolute top-12 z-50 bg-primeColor w-56 text-[#767676] h-auto p-4 pb-6"
              >
